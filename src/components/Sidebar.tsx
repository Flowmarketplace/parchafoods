      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-border">
          <div className="flex items-center gap-2">
            <img src="/ciudad-logo.png" alt="La Ciudad en tus Manos" className="h-12 w-auto" />
            <span className="font-bold text-xl bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">La Ciudad en tus Manos</span>
          </div>
          <Button
            variant="ghost"
            size="icon"
