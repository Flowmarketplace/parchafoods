...
const benefits = [
  { icon: Trophy, title: "Patrocinio Oficial del Evento", description: "Q'Menu como distribuidor oficial de carnes de Parchafoods en Cali. Permanencia y presencia en todo el evento.", highlight: true },
  ...
  { icon: Store, title: "Brandeo en Restaurantes Aliados", description: "Sticker oficial de Parchafoods brandeado con Q'Menu. Inicio con 100 restaurantes durante el Mundial y proyección de 1,200 al cierre de 2026." },
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <motion.h1 {...fadeUp} transition={{ duration: 0.6, delay: 0.25 }} className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-red-500 via-orange-400 to-yellow-400 bg-clip-text text-transparent">Parchafoods</span>
          </motion.h1>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-5">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  ...
                  con parrilla son los más visitados. Q'Menu tiene la oportunidad de posicionarse como la carne oficial detrás de cada parrilla de Parchafoods.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-5 mb-10">
            {[
              ...
              { icon: Gift, color: "from-orange-500 to-amber-500", iconColor: "text-white", title: "Promo Q'Menu", msg: "20% off en cortes premium este fin de semana en 30 restaurantes de Parchafoods 🔥", time: "Hace 2h" },
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-muted-foreground text-base leading-relaxed mb-6">
                  Con Parchafoods, Q'Menu accede a una base activa de consumidores gastronómicos en Cali,
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="text-white/60 text-lg max-w-2xl mx-auto mb-10">
              Hablemos sobre cómo Q'Menu puede ser la carne oficial de Parchafoods en Cali.
            </p>
            <a
              href="https://wa.me/573146269531?text=Hola%2C%20soy%20de%20Q%27Menu%20y%20me%20interesa%20la%20propuesta%20de%20patrocinio"
              target="_blank"
      ...
      <footer className="py-8 border-t border-border">
        <div className="container mx-auto px-6 text-center">
          <p className="text-muted-foreground text-sm">
            Parchafoods · Propuesta confidencial para Q'Menu · Cali, Colombia
          </p>
        </div>
      </footer>
    </div>
