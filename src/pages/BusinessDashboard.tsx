    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 pb-16 lg:pb-0">
      ...
      <main className="container mx-auto px-4 py-8 lg:ml-64">
        ...
        {/* Action Cards con Efectos Mejorados */}
          ...
          <Card 
            className="group hover-scale hover:shadow-2xl transition-all duration-300 cursor-pointer bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-950/30 dark:to-gray-950/30 border-2 border-slate-500/20 hover:border-slate-500/50 overflow-hidden relative"
            onClick={() => navigate('/business-analytics')}
          >
            <div className="absolute inset-0 bg-gradient-to-br from-slate-500/0 to-gray-500/0 group-hover:from-slate-500/10 group-hover:to-gray-500/10 transition-all duration-300" />
            <CardHeader className="relative">
