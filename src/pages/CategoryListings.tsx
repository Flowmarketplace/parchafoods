              ...
              <div className="pb-4 -mx-3 sm:-mx-4 md:-mx-6 px-3 sm:px-4 md:px-6">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2 sm:gap-2.5">
                  <button
                    ...
                    className={`flex flex-col items-center justify-center gap-1.5 rounded-2xl border px-2 py-3 transition-all active:scale-95 ${
                      !selectedSubcategory
                  ...
                  {availableSubcategories.map((sub) => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative flex flex-col items-center justify-center gap-1.5 rounded-2xl border px-2 py-3 transition-all active:scale-95 ${
                          isActive
                            ? 'bg-primary text-primary-foreground border-primary shadow-md'
                            : 'bg-card text-muted-foreground border-border hover:border-primary/40 hover:text-foreground hover:shadow-sm'
                        }`}
                      >
                        ...
                        <span className={`text-[10px] px-1.5 py-0.5 rounded-full leading-none ${isActive ? 'bg-white/20 text-primary-foreground' : 'bg-muted text-muted-foreground'}`}>
                          {sub.count}
                        </span>
                      </button>
                    );
