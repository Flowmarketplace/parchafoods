...
const benefits = [
  { icon: Trophy, title: "Patrocinio Oficial del Evento", description: "Andina como patrocinador oficial de Parcha Foods en Cali. Permanencia y presencia en todo el evento.", highlight: true },
  ...
  { icon: Store, title: "Brandeo en 100 Restaurantes", description: "Sticker oficial de Parcha Foods brandeado con Andina en 100 restaurantes participantes de la ciudad." },
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <motion.h1 {...fadeUp} transition={{ duration: 0.6, delay: 0.25 }} className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-yellow-400 via-amber-300 to-yellow-500 bg-clip-text text-transparent">Parcha Foods</span>
          </motion.h1>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-5 mb-10">
            {[
              ...
              { icon: Gift, color: "from-green-500 to-emerald-500", iconColor: "text-white", title: "Promo Andina", msg: "2x1 en Cerveza Andina este fin de semana en 30 restaurantes de Parcha Foods 🎉", time: "Hace 2h" },
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-muted-foreground text-base leading-relaxed mb-6">
                  Con Parcha Foods, Andina accede a una base activa de consumidores gastronómicos en Cali, 
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="text-white/60 text-lg max-w-2xl mx-auto mb-10">
              Hablemos sobre cómo Cerveza Andina puede ser la cerveza oficial de Parcha Foods en Cali.
            </p>
            <a
              href="https://wa.me/573146269531?text=Hola%2C%20soy%20de%20Andina%20y%20me%20interesa%20la%20propuesta%20de%20patrocinio"
              target="_blank"
      ...
      <footer className="py-8 border-t border-border">
        <div className="container mx-auto px-6 text-center">
          <p className="text-muted-foreground text-sm">
            Parcha Foods · Propuesta confidencial para Cerveza Andina · Cali, Colombia
          </p>
        </div>
      </footer>
    </div>
