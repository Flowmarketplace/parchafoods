                  ...
                  {nearbyPlaces.map((place) => (
                    <div key={place.id} className="relative">
                      ...
                      <button
                        ...
                        className="absolute bottom-2 right-2 z-10 bg-primary text-primary-foreground px-2.5 py-1 rounded-full text-xs font-bold shadow-lg flex items-center gap-1 hover:bg-primary/90 active:scale-95 transition-all"
                      >
